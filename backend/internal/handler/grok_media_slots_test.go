...
func newGrokMediaSlotHandler(t *testing.T, oauth, mismatch bool, platforms ...string) (*OpenAIGatewayHandler, *grokMediaSlotsCache, *grokMediaSlotBindings, *grokMediaSlotUpstream) {
	...
	// 末尾四个 nil：第 22~24 位是本 fork 的 merchantPricing / affiliateRebatePricing /
	// merchantAffiliateRebate，第 25 位才是上游原本排在第 22 位的 userPlatformQuotaRepo。
	gateway := service.NewOpenAIGatewayService(repo, nil, nil, nil, nil, nil, bindings, cfg, nil, concurrency, nil, nil, nil, upstream, nil, nil, provider, nil, nil, nil, nil, nil, nil, nil, nil)
	groupID := int64(24)
