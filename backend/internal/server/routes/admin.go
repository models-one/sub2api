...
func registerMerchantAdminRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	merchants := admin.Group("/merchants")
	{
		...
		merchants.GET("/:id/stats", mh.Stats)
		...
		merchants.GET("/:id/group_costs", mh.ListGroupCosts)
		merchants.PUT("/:id/group_costs", mh.SetGroupCost)
		merchants.DELETE("/:id/group_costs/:group_id", mh.DeleteGroupCost)
