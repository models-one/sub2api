...
func newJWTTestEnv(users map[int64]*service.User) (*gin.Engine, *service.AuthService) {
	...
	authSvc := service.NewAuthService(nil, userRepo, nil, nil, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestJWTAuth_UserLookupErrors(t *testing.T) {
	...
	// 第 13 位是本 fork 的 merchantAffiliate，第 14 位才是上游原本排在第 13 位的 userPlatformQuotaRepo。
	authSvc := service.NewAuthService(nil, nil, nil, nil, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil)
