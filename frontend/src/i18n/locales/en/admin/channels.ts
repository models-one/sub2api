export default {
    ...
    modelPricing: {
      ...
      overridesTitle: 'Price overrides (editable)',
      refresh: 'Fetch latest prices',
      refreshing: 'Fetching…',
      refreshFailed: 'Fetch failed',
      applySuccess: 'Built-in price table updated',
      applyFailed: 'Apply failed',
      source: 'Source',
      override: 'Override',
      overridden: 'Overridden',
      overrideAdded: 'Override row added: {model}. Edit then Save to apply.',
      builtinTitle: 'Built-in default prices (read-only)',
      ...
      preview: {
        ...
        removed: 'Removed',
        changed: 'Changed',
        noChanges: 'No changes vs current built-in prices',
        colModel: 'Model',
        colKind: 'Kind',
        colInput: 'Input (per 1M, $)',
        colOutput: 'Output (per 1M, $)',
        colCache: 'Cache read (per 1M, $)',
        kindAdded: 'Added',
        kindRemoved: 'Removed',
        kindChanged: 'Changed',
        apply: 'Apply',
        applying: 'Applying…',
        cancel: 'Cancel',
        truncated: 'Too many changes, showing first {n}'
      }
    }
