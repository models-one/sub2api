export default {
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 {siteName}',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 {siteName} AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    tabSubscribe: '订阅',
    noPlans: '暂无可用订阅套餐',
    notAvailable: '受风控影响，暂时关闭国内支付，请在 Telegram 小店购买进行储值或联系客服。\n接收风声和录影，货到付款，可通过 Telegram 订购。',
